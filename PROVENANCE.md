...
**Repository:** dual-boundary-admissibility-lab
**Purpose:** Admissibility Rotation Corridor — dual-boundary governance model with pressure monitoring, C-sector rotation, and HALT/HOLD logic.
**Author:** Ricky Dean Jones
**Repository owner:** [LalaSkye](https://github.com/LalaSkye)
**Organisation:** Os-Trilogy LMT / AlvianTech
**Architecture layer:** Full corridor
**Licence:** MIT
...
**Public (this repository):** Full corridor implementation, 261 tests, all modules, demo scenarios, adversarial fixes.

**Private (withheld by design):** Production deployment. Integration with external systems.
